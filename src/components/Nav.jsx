        ...
        <div className="flex items-center justify-between gap-5">
            ...
            <div className="flex justify-evenly gap-2 text-white md:gap-4 items-center text-[7.4px] sm:text-[14px] italic">
                ...
                <div className="relative group inline-block">
                    <button className=" text-white text-[7.4px] sm:text-[14px]  w-[80px]  md:w-[150px] font-medium border-none rounded cursor-pointer italic">
                        About us
                    </button>
                    <div className="absolute hidden shadow-lg z-10 group-hover:block">
                        <div className=" rounded-lg w-[80px] md:w-[150px] bg-black/90 p-4 flex flex-col gap-2 text-white text-center">
