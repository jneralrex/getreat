...
const Footer = () => {
  return (
    <footer className="font-open_sans tracking-[2px] w-full bg-[#408561] px-7 md:px-24 py-3 flex flex-col gap-3 overflow-hidden font-semibold">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:flex md:justify-between items-center w-full">
        ...
        <div className="flex items-center text-center">
          <p className="text-[13px] sm:text-[12px] md:text-[14px] lg:text-[24px] text-white ml-[-25px] lg:mr-0 ">
            +234-5005-34343
          </p>
        </div>
        <div className="h-20 w-[270px] sm:w-[180px] flex justify-center items-center">
          <form action="">
      ...
      <div className="text-white text-[10px] sm:text-[14px] w-full flex justify-center lg:justify-end">
        <ul className="flex items-center lg:w-[328px] justify-start">
